...
RiProjection(RtToken projection_type, RtToken fov_t, float fov, RtToken m),
...
RiSurface(void (*surface_shader)(FragmentShaderPayload& p)),
...
extern RtVoid
RiSphere(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat tmax, RtToken m),
RiSphereV(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat tmax,
	RtInt n, RtToken tokens[], RtPointer parms[]),
	RiCone(RtFloat height, RtFloat radius, RtFloat tmax, RtToken m),
	RiConeV(RtFloat height, RtFloat radius, RtFloat tmax,
		RtInt n, RtToken tokens[], RtPointer parms[]),
	RiCylinder(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat tmax, RtToken m),
	...
	RiTorus(RtFloat majrad, RtFloat minrad, RtFloat phimin,
		RtFloat phimax, RtFloat tmax, RtToken m),
